...
enum RBACPermissions
{
    ...
    /* LEGACY: COMMANDS*/
	RBAC_PERM_COMMAND_DM                                     = 797,
	RBAC_PERM_COMMAND_DM_ON                                  = 798,
	RBAC_PERM_COMMAND_DM_OFF                                 = 799,
	RBAC_PERM_COMMAND_WARP                                   = 800,
	RBAC_PERM_COMMAND_GRANTLIFE                              = 801,
	RBAC_PERM_COMMAND_TAKELIFE                               = 802,
	RBAC_PERM_COMMAND_GOBJECT_SET_SCALE                      = 803,
	RBAC_PERM_COMMAND_NPC_DELETE_ENTRY                       = 804,
    RBAC_PERM_COMMAND_NPC_MODIFY                             = 805,
    RBAC_PERM_COMMAND_NPC_MODIFY_AURA                        = 806,
    RBAC_PERM_COMMAND_NPC_MODIFY_BYTES1                      = 807,
    RBAC_PERM_COMMAND_NPC_MODIFY_BYTES2                      = 808,
    RBAC_PERM_COMMAND_NPC_MODIFY_DEATHSTATE                  = 809,
    RBAC_PERM_COMMAND_NPC_MODIFY_EMOTESTATE                  = 810,
    RBAC_PERM_COMMAND_NPC_MODIFY_FACTION                     = 811,
    RBAC_PERM_COMMAND_NPC_MODIFY_MODEL                       = 812,
    RBAC_PERM_COMMAND_NPC_MODIFY_SPAWNDIST                   = 813,
    RBAC_PERM_COMMAND_NPC_MODIFY_SPAWNTIME                   = 814,
    RBAC_PERM_COMMAND_NPC_MODIFY_WEAPONS                     = 815,
    RBAC_PERM_COMMAND_CARPUS_LINK                            = 816,
    RBAC_PERM_COMMAND_NPC_SOUND                              = 817,
    RBAC_PERM_COMMAND_NPC_SOUNDFULL                          = 818,
    RBAC_PERM_COMMAND_NPC_MODIFY_MOUNT                       = 819,
    RBAC_PERM_COMMAND_NPC_MODIFY_FLY                         = 820,
    RBAC_PERM_COMMAND_NPC_CLONE                              = 821,

    /* LEGACY: OTHER */
    RBAC_PERM_CREATE_SKIP_MAX_CHARACTERS                     = 900,
