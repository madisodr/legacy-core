...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        void DeleteCreatureTemplate(uint32 entry);
        ...
        bool InsertCreatureTemplate(uint32 entry);
        ...
        void updateCreatureData(uint32 guid, CreatureData data) { _creatureDataStore[guid] = data; }
