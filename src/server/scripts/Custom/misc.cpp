...
public:
    ...
    {
        //player->Whisper("Hello world", LANG_COMMON, player);
        //if (player->GetTeamId() == TEAM_ALLIANCE)
        // {
        //   player->Whisper("Hello Alliance world", LANG_COMMON, player);
        ...
        //	else
        //   {
        //      player->Whisper("Hello Horde world", LANG_COMMON, player);
