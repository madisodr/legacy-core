...
public:
    ...
    struct npc_mirror_imageAI : CasterAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            me->CastSpell(me->GetVictim(), 58838, false);
        }
...
public:
    ...
    struct npc_snake_trap_serpentsAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            me->SetStatFloatValue(UNIT_FIELD_RANGED_ATTACK_POWER, 1.0f);
...
/*
Script disabled. See comment near the end by -Pendragon
...
public:
    ...
    struct mob_mojoAI : public ScriptedAI
    {
        ...
        void ReceiveEmote(Player* player, uint32 emote)
        {
            ...
            me->Whisper(whisp.c_str(), player->GetGUID());
            if (victimGUID)
            if (Player* victim = Unit::GetPlayer(*me, victimGUID)) // I don't know how to retrieve this. This function no longer exists. -Pendragon
